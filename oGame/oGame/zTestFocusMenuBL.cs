...
namespace oGame
{
    public class zTestFocusMenuBL : GameScreen
    {
        Texture2D background;
        Rectangle backgroundRectangle; 
        public zTestFocusMenuBL()
            :base()
        {
            IsSoftPopup = true;
        ...
        public override void LoadContent()
        {
             try
             {
                 ...
                 backgroundRectangle = new Rectangle(ScreenFactory.TitleSafeArea.Left, ScreenFactory.TitleSafeArea.Bottom - background.Height, background.Width, background.Height);
