...
namespace oEngine.Factories
{
    ...
    /// </remarks>
    public class ScreenFactory : DrawableGameComponent
    {
        #region Fields
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            while (screensToUpdate.Count > 0)
            {
                ...
                if (screen.ScreenState == Enums.ScreenState.TransitionOn ||
                    screen.ScreenState == Enums.ScreenState.Active)
                {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                if (screen.ScreenState == Enums.ScreenState.Hidden)
                    continue;
