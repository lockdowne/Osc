...
namespace oEngine.Screens
{
    ...
    public abstract class GameScreen
    {
        ...
        /// </summary>
        public Enums.ScreenState ScreenState
        {
            get { return screenState; }
            protected set { screenState = value; }
        }

        Enums.ScreenState screenState = Enums.ScreenState.TransitionOn;
        ...
        public bool IsActive
        {
            get
            {
                return !otherScreenHasFocus &&
                       (screenState == Enums.ScreenState.TransitionOn ||
                        screenState == Enums.ScreenState.Active);
            }
        }
                                                      ...
                                                      bool coveredByOtherScreen)
        {
            ...
            if (isExiting)
            {
                ...
                screenState = Enums.ScreenState.TransitionOff;
            ...
            else if (coveredByOtherScreen)
            {
                ...
                {
                    // Transition finished!
                    screenState = Enums.ScreenState.Hidden;
                }
            }
            else
            {
